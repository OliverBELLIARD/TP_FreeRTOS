 ...
 * @Note
 *
 * 	-	As a solution for this message:
 ...
 * 		use a timer to use the HAL time base. more info in forum:
 * 		https://community.st.com/t5/stm32-mcus-products/cubemx-freertos-gt-using-systick/td-p/412607
 *
 * 	-	As a solution for the message:
 * 		"The USE_NEWLIB_REENTRANT must be set in order to make sure that
 * 		newlib is fully reentrant.  The option will increase the RAM usage.
 * 		Enable this option under
 * 		FreeRTOS > Advanced Settings > USE_NEWLIB_REENTRANT"
 * 		When enabling FreeRTOS
 *
 ******************************************************************************
 */
